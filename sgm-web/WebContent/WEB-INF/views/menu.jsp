...
<head>
  ...
  <!-- Calendar -->
  <link rel="stylesheet" href="resources/style/fullcalendar.css">
  <!-- prettyPhoto -->
  <link rel="stylesheet" href="resources/style/prettyPhoto.css">  
  <!-- Star rating -->
  <link rel="stylesheet" href="resources/style/rateit.css">
  <!-- Date picker -->
  <link rel="stylesheet" href="resources/style/bootstrap-datetimepicker.min.css">
  <!-- CLEditor -->
  <link rel="stylesheet" href="resources/style/jquery.cleditor.css"> 
  <!-- Bootstrap toggle -->
  <link rel="stylesheet" href="resources/style/bootstrap-switch.css">
  <!-- Main stylesheet -->
  <link href="resources/style/style.css" rel="stylesheet">
  <!-- Widgets stylesheet -->
  <link href="resources/style/widgets.css" rel="stylesheet">   
        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <i class="icon-user"></i> <c:out value="${usuarioLogado.login}" /> <b class="caret"></b>              
            </a>
...
<script src="resources/js/jquery-ui-1.9.2.custom.min.js"></script> <!-- jQuery UI -->
<script src="resources/js/fullcalendar.min.js"></script> <!-- Full Google Calendar - Calendar -->
<script src="resources/js/jquery.rateit.min.js"></script> <!-- RateIt - Star rating -->
<script src="resources/js/jquery.prettyPhoto.js"></script> <!-- prettyPhoto -->
...
<script src="resources/js/jquery.noty.js"></script> <!-- jQuery Notify -->
<script src="resources/js/themes/default.js"></script> <!-- jQuery Notify -->
<script src="resources/js/layouts/bottom.js"></script> <!-- jQuery Notify -->
<script src="resources/js/layouts/topRight.js"></script> <!-- jQuery Notify -->
<script src="resources/js/layouts/top.js"></script> <!-- jQuery Notify -->
<!-- jQuery Notification ends -->

<script src="resources/js/sparklines.js"></script> <!-- Sparklines -->
<script src="resources/js/jquery.cleditor.min.js"></script> <!-- CLEditor -->
<script src="resources/js/bootstrap-datetimepicker.min.js"></script> <!-- Date picker -->
<script src="resources/js/bootstrap-switch.min.js"></script> <!-- Bootstrap Toggle -->
<script src="resources/js/filter.js"></script> <!-- Filter for support page -->
<script src="resources/js/custom.js"></script> <!-- Custom codes -->
<script src="resources/js/charts.js"></script> <!-- Charts & Graphs -->
